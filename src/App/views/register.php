...
<section class="max-w-2xl mx-auto mt-12 p-4 bg-white shadow-md border border-gray-200 rounded">
    <form method="POST" class="grid grid-cols-1 gap-6">
        ...
        <label class="block">
            ...
            <input type="email" value="<?php echo e($oldFormData['email'] ?? ''); ?>" name="email" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="john@example.com" />
        ...
        <label class="block">
            ...
            <input type="number" value="<?php echo e($oldFormData['age'] ?? ''); ?>" name="age" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="" />
        ...
        <label class="block">
            ...
            <select name="country" class="block w-full mt-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                ...
                <option value="France" <?php echo $oldFormData['country'] === 'France' ? 'selected' : ''; ?>>France
                </option>
        ...
        <label class="block">
            ...
            <input type="text" value="<?php echo e($oldFormData['socialMediaURL'] ?? ''); ?>" name="socialMediaURL" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="" />
